...
BATTLED_TAMERS_LOCATIONS: Dict[str, DMW2003Flag] = {
    "Tamer Genji (Asuka City)": DMW2003Flag(0, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Natsumi (Central Park)": DMW2003Flag(1, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Mitch (Wire Forest Entrance)": DMW2003Flag(2, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Catherine (West Wire Forest)": DMW2003Flag(3, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Lucia (East Wire Forest)": DMW2003Flag(4, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Robert (East Wire Forest)": DMW2003Flag(5, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Akiba (Wind Prarie)": DMW2003Flag(6, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Bob (Kicking Forest)": DMW2003Flag(7, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Tomomi (East Station)": DMW2003Flag(8, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Chris (Seiryu City)": DMW2003Flag(9, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Andy (South Station)": DMW2003Flag(10, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer George (Bulk Swamp)": DMW2003Flag(11, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Mei Lin (Bulk Bridge)": DMW2003Flag(12, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Jessica (Tranquil Swamp)": DMW2003Flag(13, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Gordon (South Cape)": DMW2003Flag(14, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Alice (Suzaku City)": DMW2003Flag(15, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Nakano (Asuka Mirage Hall)": DMW2003Flag(16, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Haruka (Boot Mountain)": DMW2003Flag(17, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Poemy (Snow Mountain)": DMW2003Flag(18, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Shingo (Boot Mountain)": DMW2003Flag(19, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Makoto (Kulon Mine)": DMW2003Flag(20, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Brown (Kulon Mine)": DMW2003Flag(21, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Pierre (Asuka Legendary Gym)": DMW2003Flag(22, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Mitaka (Kulon Pit)": DMW2003Flag(23, DMW2003FlagType.BATTLED_TAMERS),
    # Troopers
    ...
    "Tamer Heinrich (Amaterasu Mirage Tower)": DMW2003Flag(42, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Takuya (Amaterasu Mirage Hall)": DMW2003Flag(43, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Murdock (Amaterasu Mirage Hall)": DMW2003Flag(44, DMW2003FlagType.BATTLED_TAMERS),
    "Guard Banch (Amaterasu Mirage Hall)": DMW2003Flag(45, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Mai (Amaterasu Legendary Gym)": DMW2003Flag(52, DMW2003FlagType.BATTLED_TAMERS),
    "Tamer Gon (Amaterasu Legendary Gym)": DMW2003Flag(53, DMW2003FlagType.BATTLED_TAMERS),
}
